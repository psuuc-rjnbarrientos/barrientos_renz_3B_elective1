...
Route::delete('/projects/{id}/delete', [ProjectController::class, 'destroy'])->name('projects.destroy'); // Delete project
...
Route::delete('/tasks/{taskId}/delete', [TaskController::class, 'destroy'])->name('tasks.destroy'); // Delete task
